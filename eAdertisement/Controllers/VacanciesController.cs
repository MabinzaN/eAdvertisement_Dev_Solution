...
namespace eAdertisement.Controllers
{
    public class VacanciesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VacancyId,ExpiredVacancyId,DepartmentId,PendingVacancyId,PublishedVacancyId,UnpublishedVacancyId,Post,Attention,ClosingDate,Telephone,Salary,Centre,Application,Note,Duties,ReferenceNo,Level")] Vacancy vacancy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VacancyId,ExpiredVacancyId,DepartmentId,PendingVacancyId,PublishedVacancyId,UnpublishedVacancyId,Post,Attention,ClosingDate,Telephone,Salary,Centre,Application,Note,Duties,ReferenceNo,Level")] Vacancy vacancy)
        {
            if (ModelState.IsValid)
            {
